...
Published at **https://overdrivelabs998.github.io/timeboard-privacy/** (the data-deletion page is at `/delete-data.html`, and a feedback form that composes an email to overdrivelabs998@gmail.com is at `/feedback.html`); those are the URLs used in the Google Play listing.
